  ...
  <div className="max-w-5xl mx-auto px-4">
    ...
    <div className="flex items-center justify-between h-16">
      ...
      <Image  class="rounded-full" src={image1} width={250} height={250}/>
       ...
       <section>
        ...
        <h3 className="text-4xl py-1 text-teal-600 ">Gallery</h3>
         <section >
            <h1 class= " h-40">              
            </h1>
            </section> 
      ...
      <section >
          ...
          <section >
           ...
           <h3 className="text-4xl py-1 text-teal-600 " >About</h3>
            <section >
            <h1 class= "h-20">              
            </h1>
            </section>
        ...
        <h3 className="text-4xl py-1 text-teal-600 ">Skills</h3>
            <div className="text-center shadow-lg p-10 rounded-xl my-10  dark:bg-white flex-1">
              ...
              <p className="py-2">
                My first introduction to Java was through Object Oriented Programming.<br/>  (OOP)
              </p>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <p className="py-2">
                I have used C# when I was doing Qaulity Assurance, where i did different kinds of tests.
              </p>
    ...
    <div class="-mx-4 flex flex-wrap lg:justify-between">
      <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
        ...
        <h3 className="text-4xl py-1 text-teal-600 ">Contact Me</h3>
